...
const resources = {
  en: {
    translation: {
      ...
      pendingTrainingsSubtitle: 'Complete assigned trainings to stay compliant.',
      ...
      course: 'Course',
      analyticsFiltersDepartmentPlaceholder: 'All departments',
      analyticsFiltersJobPlaceholder: 'All positions',
      analyticsFiltersCoursePlaceholder: 'All courses',
      analyticsDateFrom: 'Start date',
      analyticsDateTo: 'End date',
      analyticsResetFilters: 'Reset filters',
      analyticsOverallCompliance: 'Overall compliance',
      analyticsParticipants: '{{count}} participants',
      analyticsCompletedTrainings: 'Completed trainings',
      analyticsPendingTrainings: 'Pending trainings',
      analyticsOverdueTrainings: 'Overdue trainings',
      analyticsAvgQuizScore: 'Avg quiz score',
      analyticsAvgCompletionHours: 'Avg completion time (hrs)',
      analyticsMomentum: 'Momentum (last 30 days)',
      analyticsMomentumComparison: 'vs previous 30 days',
      analyticsMomentumUnits: 'completions',
      analyticsTopEmployees: 'Top 10 compliant employees',
      analyticsBottomEmployees: '10 employees needing attention',
      analyticsTopDepartments: 'Top departments',
      analyticsBottomDepartments: 'At-risk departments',
      analyticsMonthlyTrend: '6-month completion trend',
      analyticsContentTypeMix: 'Content type mix',
      analyticsCourseHighlights: 'Course highlights',
      analyticsDueSoon: 'Due soon',
      analyticsNoData: 'No data available yet',
      analyticsAssignments: 'assignments',
      analyticsDaysRemaining: '{{count}} days remaining',
  ...
  es: {
    translation: {
      ...
      pendingTrainingsSubtitle: 'Completa las capacitaciones asignadas para mantener el cumplimiento.',
      ...
      course: 'Curso',
      analyticsFiltersDepartmentPlaceholder: 'Todos los departamentos',
      analyticsFiltersJobPlaceholder: 'Todos los puestos',
      analyticsFiltersCoursePlaceholder: 'Todos los cursos',
      analyticsDateFrom: 'Fecha inicio',
      analyticsDateTo: 'Fecha fin',
      analyticsResetFilters: 'Restablecer filtros',
      analyticsOverallCompliance: 'Cumplimiento general',
      analyticsParticipants: '{{count}} participantes',
      analyticsCompletedTrainings: 'Capacitaciones completadas',
      analyticsPendingTrainings: 'Capacitaciones pendientes',
      analyticsOverdueTrainings: 'Capacitaciones vencidas',
      analyticsAvgQuizScore: 'Promedio de quiz',
      analyticsAvgCompletionHours: 'Tiempo promedio (hrs)',
      analyticsMomentum: 'Impulso (últimos 30 días)',
      analyticsMomentumComparison: 'vs 30 días anteriores',
      analyticsMomentumUnits: 'finalizaciones',
      analyticsTopEmployees: 'Top 10 empleados cumplidores',
      analyticsBottomEmployees: '10 empleados que requieren atención',
      analyticsTopDepartments: 'Mejores departamentos',
      analyticsBottomDepartments: 'Departamentos en riesgo',
      analyticsMonthlyTrend: 'Tendencia de 6 meses',
      analyticsContentTypeMix: 'Mezcla por tipo de contenido',
      analyticsCourseHighlights: 'Cursos destacados',
      analyticsDueSoon: 'Próximos vencimientos',
      analyticsNoData: 'Aún no hay datos disponibles',
      analyticsAssignments: 'asignaciones',
      analyticsDaysRemaining: '{{count}} días restantes',
      analyticsDueToday: 'Vence hoy',
